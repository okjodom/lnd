...
func (x *FeeLimit) GetPercent() uint64 {
...
type FeeLimit_Percent struct {
	...
	Percent uint64 `protobuf:"varint,2,opt,name=percent,proto3,oneof"`
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x1a, 0x0a, 0x07, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04,
